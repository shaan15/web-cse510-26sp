...
Course activities are based in a combination of readings, active discussion and reflection, and a self-defined group project.
...
- **Contact**
  ...
  The course staff email list promotes both staff coordination and a more prompt response.
  Emails to individual course staff will typically have the list added to any response.
...
- **Course Time & Location**
  ...
  {/*
  Room [G04](https://www.washington.edu/classroom/CSE2+G04).
  */}
...
but it is your responsibility to communicate with us if you would like additional guidance.

The overall course grade will be computed as follows:

- **15%: Readings, Discussion Posts, and In-Class Small Group Discussions.**
...
- **15%: Student-Led Presentations and Discussion Facilitation.**
  ...
  All students will take on an appropriate share of student-led presentations and discussion facilitation,
  including coordinating with course staff to ensure coverage of all necessary roles.

- **45%: Project.**
  - 5%: Proposal Preparation and Document.
  - 5%: Milestone 1 Report and Discussion.
  - 5%: Milestone 2 Report and Discussion.
  - 30%: Final Report.

  Project proposal and milestone grading will emphasize progress and preparation to engage with feedback.
  Strong grades will result from honest presentation of project status and preparation for a discussion that can support the project
...
- **10%: Participation.**
  ...
  (e.g., being present for discussions, being engaged in discussions).

If necessary, the grades of specific assignments may also be adjusted based on participation and contribution.
Any such adjustments will be applied as part of course grade calculation at the end of the quarter
...
(e.g., expecting clear and early communication,
...
Because reflection grading is both subjective and anonymous, we will be averse to revising the grade of a reflection.
We will proactively work to be fair in the grading of these assignments,
then expect we would decline any request to revisit the grade of a reflection
...
This is intended to provide confidence that final grades were not defined by any minor point deduction.

### Generative AI Policy

We understand that generative AI is a commonly-used tool in many contexts. 
We encourage you to be thoughtful in your use of any tool, 
ensuring that your tools do not undermine your learning goals or the intent of course assignments. 
Remember that you are responsible for all content of your submitted work, regardless of what tools you used to help create it.
...
including any context you share about the need for an absence.
We will do our best to be accommodating amidst requirements and expectations of the course.
...
Recorded sessions will be available within Canvas.
We expect recordings will be of relatively poor quality
...
Zoom participation will use meeting information provided by email and in Canvas.
