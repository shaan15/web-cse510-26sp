...
For a reading or project from outside the course, we strongly encourage but do not require you to seek course staff pre-approval.
...
Method reflections that do not adhere to the above constraints on paper and research selection will not receive credit.
...
- Briefly summarize elements of the method-focused reading that are most relevant to insights you will discuss.
  We encourage being explicit in the understanding developed through method-focused reading
